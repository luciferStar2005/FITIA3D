...
public class RutinaController {
    ...
    public ResponseEntity<ProgresoRutinaResponse> finalizarRutina(@RequestBody FinalizarRutinaRequest request) {
        return ResponseEntity.ok(service.finalizarRutina(request));
    }

    @GetMapping("/progreso")
    public ResponseEntity<ProgresoRutinaResponse> obtenerProgreso(@RequestParam String fecha) {
        return ResponseEntity.ok(service.getProgresoPorFecha(fecha));
    }

    @GetMapping("/racha")
    public ResponseEntity<RachaResponse> obtenerRacha() {
        return ResponseEntity.ok(service.getRachaActual());
    }
}
