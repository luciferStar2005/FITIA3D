...
<<<<<<< HEAD
                        <li><Link to="/biblioteca" className="text-white hover:text-red-400 font-bold uppercase text-xs tracking-widest transition-colors">Biblioteca</Link></li>
=======
...
<<<<<<< HEAD
                        <li><Link to="/biblioteca" className="text-white hover:text-red-400 block p-4 border-b border-neutral-700 font-bold uppercase text-xs tracking-widest">Biblioteca</Link></li>
=======
                        <li><Link to="/biblioteca-animaciones" className="text-white hover:text-red-400 font-bold uppercase text-xs tracking-widest transition-colors">Biblioteca De Ejercicios</Link></li>
>>>>>>> juan/CorrecionesFront
