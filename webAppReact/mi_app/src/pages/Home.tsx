...
import { planHoyData, kaloriasData, metasData, progresoData } from '../data/mockData';
import { porcentaje } from '../utils/helpers';
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-min gap-4 m-4 md:m-8 min-h-screen pt-20 lg:pt-10">
                <div className="col-span-1 md:col-span-12 lg:col-span-8 bg-neutral-800 border-l-4 border-red-500 rounded-md">
                    <h1 className="text-red-200 m-2 font-['Bebas_Neue'] text-3xl tracking-wider">Plan de hoy</h1>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-2 max-h-[300px] overflow-auto lg:max-h-[200px] lg:flex">
                        {planHoyData.map((ejercicio: PlanHoyData) => (
                            <div key={ejercicio.id} className="bg-neutral-700 rounded-md p-4 min-w-[300px] flex flex-row justify-between">
                                <div>
                ...
                <div className="col-span-1 md:col-span-6 lg:col-span-2 bg-neutral-800 rounded-md">
                    <h3 className="flex text-orange-200 m-2 font-['Bebas_Neue'] text-2xl tracking-wider items-center gap-2">
                        Kalorias
                ...
                <div className="col-span-1 md:col-span-6 lg:col-span-2 bg-neutral-800 rounded-md">
                    <h3 className="flex text-blue-200 m-2 font-['Bebas_Neue'] text-2xl tracking-wider items-center gap-2">Analisis IA
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                ...
                <div className="col-span-1 md:col-span-6 lg:col-span-4 bg-neutral-800 rounded-md ">
                    <h3 className="flex text-green-200 m-2 font-['Bebas_Neue'] text-2xl tracking-wider items-center gap-2">Metas
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                ...
                <div className="col-span-1 md:col-span-6 lg:col-span-8 bg-neutral-800 rounded-md">
                    <h3 className="text-purple-200 m-2 font-['Bebas_Neue'] text-2xl tracking-wider">Progreso</h3>
